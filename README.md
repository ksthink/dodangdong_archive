...
글꼴은 **갈무리**(Galmuri) 하나뿐이고 각 글꼴이 선명한 크기의 배수에서만 쓴다 —
Galmuri11 은 12px 격자(12·24·36·48), 보조 글은 Galmuri14 원래 크기 15px.
본문 24px에서 한 픽셀이 정확히 선 두께(`--stroke`)와 같다. 읽는 글은 24px, 보조 글은 15px,
날짜·식별자 같은 기계 값만 12px.
